...
export function BaseNode({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "bg-card text-card-foreground relative rounded-md border flex flex-col",
        "hover:ring-1",
...
export function BaseNodeHandles({
  className,
  ...props
}: ComponentProps<"div">) {
  return (
    <div
      data-slot="base-node-handles"
      className={cn(
        "pointer-events-none absolute inset-0 mt-2 mb-2 gap-2",
        className,
      )}
      {...props}
    />
